...
public class MySurfaceVew extends SurfaceView {
    protected Point mVideoSize;

    public MySurfaceVew(Context context) {
        super(context);
        init();
    }

    public MySurfaceVew(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MySurfaceVew(Context context, AttributeSet attrs, int defStyleAttr) {
